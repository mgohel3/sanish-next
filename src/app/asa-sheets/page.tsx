  ...
  return (
    <main style={{ backgroundColor: "var(--bg-primary)" }} className="min-h-screen">
      ...
      <PageHero
        ...
        description="Weather-resistant ASA surface sheets engineered for outdoor furniture, cladding and high-exposure architectural applications."
      />
      <Suspense fallback={
        ...
        <ProductListClient category="ASA Sheets" basePath="/asa-sheets" categoryLabel="ASA Sheets" />
      </Suspense>
      <Footer />
    </main>
  );
