          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-[11px] uppercase tracking-[0.2em] font-medium"
                style={{ color: C.accent, fontFamily: "var(--font-poppins)" }}>Dealer Network</span>
            </div>
            <h2 className="font-medium leading-[1.1] mb-6"
              style={{ fontSize: "clamp(34px,4vw,50px)", fontFamily: "var(--font-vogue)", color: C.textP, letterSpacing: "-0.01em" }}>
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/find-a-dealer"
                ...
                style={{ backgroundColor: C.accent, borderRadius: "999px", fontFamily: "var(--font-poppins)", letterSpacing: "0.04em" }}>
                Become a Dealer
              ...
              <Link href="/find-a-dealer"
                ...
                style={{ color: C.accent, borderColor: C.accent, borderRadius: "999px", fontFamily: "var(--font-poppins)", letterSpacing: "0.04em" }}>
                Find Nearest Dealer
              </Link>
            </div>
          </div>
            ...
            <div className="flex flex-wrap gap-2.5 mb-8">
              {STATES.map((state) => (
                <span key={state} className="text-[12px] font-medium px-4 py-2"
                  style={{ backgroundColor: C.card, color: C.textP, borderRadius: "999px", border: `1px solid ${C.border}`, fontFamily: "var(--font-poppins)" }}>
                  {state}
                </span>
              ))}
              <span className="text-[12px] font-semibold px-4 py-2"
                style={{ backgroundColor: C.accent, color: "white", borderRadius: "999px", fontFamily: "var(--font-poppins)" }}>
                + more
              </span>
            </div>
              ...
              {[
                ...
                <div key={s.l} className="text-center p-5"
                  ...
                  <div className="text-[28px] font-semibold leading-none mb-1"
                    style={{ fontFamily: "var(--font-vogue)", color: C.accent, letterSpacing: "-0.01em" }}>
                    {s.v}
                  </div>
