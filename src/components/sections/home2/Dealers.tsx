          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-[11px] uppercase tracking-[0.2em] font-medium"
                style={{ color: C.accent, fontFamily: "var(--font-heebo)" }}>Dealer Network</span>
            </div>
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/find-a-dealer"
                ...
                style={{ backgroundColor: C.accent, borderRadius: "999px", fontFamily: "var(--font-heebo)", letterSpacing: "0.04em" }}>
                Become a Dealer
              ...
              <Link href="/find-a-dealer"
                ...
                style={{ color: C.accent, borderColor: C.accent, borderRadius: "999px", fontFamily: "var(--font-heebo)", letterSpacing: "0.04em" }}>
                Find Nearest Dealer
              </Link>
            </div>
          </div>
            ...
            <div className="flex flex-wrap gap-2.5 mb-8">
              {STATES.map((state) => (
                <span key={state} className="text-[12px] font-medium px-4 py-2"
                  style={{ backgroundColor: C.card, color: C.textP, borderRadius: "999px", border: `1px solid ${C.border}`, fontFamily: "var(--font-heebo)" }}>
                  {state}
                </span>
              ))}
              <span className="text-[12px] font-semibold px-4 py-2"
                style={{ backgroundColor: C.accent, color: "white", borderRadius: "999px", fontFamily: "var(--font-heebo)" }}>
                + more
              </span>
            </div>
